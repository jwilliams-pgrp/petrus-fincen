...
business = pandas.read_csv(rf'C:\Users\williamsje\Downloads\Fincen\Business_{AsOfDate_File}.csv')

# People file directory
people = pandas.read_csv(rf'C:\Users\williamsje\Downloads\Fincen\Person_{AsOfDate_File}.csv')
...
with pandas.ExcelWriter(rf'C:\Users\williamsje\Downloads\Fincen\Fincen_{AsOfDate_File}.xlsx') as writer:
